...
CREATE TABLE HISTOIRES (
    id SERIAL PRIMARY KEY,   -- Identifiant unique auto-incrémenté pour chaque histoire
...
CREATE TABLE QUESTIONS (
    ...
    id_histoire INTEGER NOT NULL,            -- Référence à l'identifiant de l'histoire associée
    question VARCHAR(100),                   -- Question liée à l'histoire
    reponse VARCHAR(50),                     -- Réponse à la question
...
CREATE TABLE PROGRESSION (
    ...
    statut CHAR CHECK (statut IN ('n', 'c', 'f')),  -- Statut de progression ('n' = non tenté, 'c' = en cours, 'f' = fini)
    FOREIGN KEY (user_id) REFERENCES USERS(id),  -- Clé étrangère référencée à la table USERS 
