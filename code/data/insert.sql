...
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,1,'Ça ne vous fait pas peur vous qu’on ait perdu aussi vite ?',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,3,'Mais non ! Tout va bien, c’est de l’autre coté de la France, il n''y a pas de raison que ça nous impacte.
 ',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,2,'Exactement, maintenant amuse-toi avec nous ! ',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,5,'Le sort de tes parents ne t’inquiète pas pierre ?',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,10,'David est assis sur un lit dans un coin de la pièce, a son habitude.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,5,'Ils habitent dans le nord pourtant non ?',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,10,'Pierre garde le sourire, mais son expression se crispe un peu en entendant ces mots. Après quelques moments
de réflexion, il rétorque.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,2,'Non, ils se sont déjà eloignés des conflits depuis quelques mois. Demande plutôt a André, ses
parents à lui refusent de se mettre en sécurité ',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,4,'Et je les comprends, dans tous les cas personnes n’oserai les y forcer, ils sont bien trop puissants.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,5,'L’argent ne sauve pas de tout tu sais ?',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,4,'C’est cela, et il ne fait pas le bonheur non plus.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,2,'Bon ce n’est pas tout ça mais cette radio me déprime... J’ai entendu parler d’une radio qui diffuse
encore de la musique sur la fréquence 89.9, je vais essayer de la capter. ',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,10,'Pierre commence alors à manipuler la radio pendant un long moment. Jusqu''à ce que quelqu''un l''interrompe soudainement.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,5,'Attends !',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,3,'Je crois que j’ai entendu quelque chose moi aussi, reviens en arrière.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,1,'La radio grésille jusqu''à ce que retentissent des mots que nous n’oublierions jamais.',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,9,'Malgré nos efforts, nous avons été submergés par la force terrestre et aérienne de l''ennemi...',false);
INSERT INTO DIALOGUES(id,id_histoire,interlocuteur,contenu,bonus) VALUES (2,1,9,'Dès demain matin, nous engageons la mobilisation générales des citoyens français dans ces combats.',false);
