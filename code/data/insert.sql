...
--Début des questions
(18, 1, 10, 'Vous allez maintenant être confronté à deux questions pour pouvoir faire avancer nos héros, à vous de choisir laquelle vous convient le mieux. La suite de cette histoire ne dépend que de vous...', false,'181'),
...
(36,1,3,'Ça... ça ressemblait à un appel à l’aide… Non ? ',true,'361'),
...
(77,2,3,'Il n’y a sûrement plus rien à manger mais les matelas devraient être là, vous devriez pouvoir vous
installer dans une chambre pour dormir.',true,'772'),
(78,2,3,'Les Vasseur montent à l’étage pendant que Raymond et moi nous installons dans le salon, sur ce qui semble être des 
...
(90, 2, 3, 'Il semblerait que je n’ai plus qu’à espérer que Raymond ait réussi à s’enfuir avec les Vasseur.', true,'902');
