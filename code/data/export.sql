...
INSERT INTO dialogues VALUES (2, 1, 1, 'Éteint ça, on va se faire repérer !', false, '21.mp3');
INSERT INTO dialogues VALUES (4, 1, 2, 'Mais non ! Arrête de t’inquiéter pour rien, les surveillants sont tous bien trop occupés à écouter la leur de radio, il n’y a aucun risque pour nous.', false, '41.mp3');
INSERT INTO dialogues VALUES (5, 1, 3, '𝐽𝑒 𝑡𝑒𝑛𝑑𝑠 𝑎𝑙𝑜𝑟𝑠 𝑢𝑛 𝑣𝑒𝑟𝑟𝑒 à Raymond. 𝐷𝑒 𝑙𝑎 𝑔𝑛𝑜𝑙𝑒 𝑓𝑎𝑖𝑡𝑒 𝑝𝑎𝑟 𝑚𝑜𝑛 𝑔𝑟𝑎𝑛𝑑-𝑝𝑒̀𝑟𝑒 𝑞𝑢𝑒 𝑗’𝑎𝑖 𝑟𝑎𝑚𝑒𝑛𝑒́ 𝑖𝑙 𝑦 𝑎 𝑑𝑒́𝑗𝑎̀ 𝑞𝑢𝑒𝑙𝑞𝑢𝑒𝑠 semaines de ça. 𝑅𝑎𝑦𝑚𝑜𝑛𝑑 𝑙’𝑎𝑐𝑐𝑒𝑝𝑡𝑒 𝑎 𝑐𝑜𝑛𝑡𝑟𝑒-𝑐œ𝑢𝑟 𝑒𝑡 𝑒𝑛 𝑝𝑟𝑒𝑛𝑑 𝑢𝑛𝑒 𝑔𝑜𝑟𝑔𝑒́𝑒.', false, '51.mp3');
INSERT INTO dialogues VALUES (6, 1, 1, 'Ça ne vous fait pas peur vous qu’on ait perdu aussi vite ?', false, '61.mp3');
INSERT INTO dialogues VALUES (7, 1, 3, 'Mais non ! Tout va bien, c’est de l’autre coté de la France, il n''y a pas de raison que ça nous impacte.', false, '71.mp3');
INSERT INTO dialogues VALUES (8, 1, 2, 'Exactement, maintenant amuse-toi avec nous !', false, '81.mp3');
INSERT INTO dialogues VALUES (9, 1, 5, 'Le sort de tes parents ne t’inquiète pas pierre ?', false, '91.mp3');
INSERT INTO dialogues VALUES (10, 1, 10, 'David est assis sur un lit dans un coin de la pièce, a son habitude.', false, '101.mp3');
INSERT INTO dialogues VALUES (11, 1, 5, 'Ils habitent dans le nord pourtant non ?', false, '111.mp3');
INSERT INTO dialogues VALUES (12, 1, 10, 'Pierre garde le sourire, mais son expression se crispe un peu en entendant ces mots. Après quelques moments de réflexion, il rétorque.', false, '121.mp3');
INSERT INTO dialogues VALUES (13, 1, 2, 'Non, ils se sont déjà éloignés des conflits depuis quelques mois. Demande plutôt à André, ses parents à lui refusent de se mettre en sécurité', false, '131.mp3');
INSERT INTO dialogues VALUES (14, 1, 4, 'Et je les comprends, dans tous les cas personnes n’oserait les y forcer, ils sont bien trop puissants.', false, '141.mp3');
INSERT INTO dialogues VALUES (15, 1, 5, 'L’argent ne sauve pas de tout tu sais ?', false, '151.mp3');
INSERT INTO dialogues VALUES (16, 1, 4, 'C’est cela, et il ne fait pas le bonheur non plus.', false, '161.mp3');
INSERT INTO dialogues VALUES (17, 1, 2, 'Bon ce n’est pas tout ça mais cette radio me déprime... J’ai entendu parler d’une radio qui diffuse encore de la musique sur la fréquence 89.9, je vais essayer de la capter.', false, '171.mp3');
INSERT INTO dialogues VALUES (18, 1, 10, 'Vous allez maintenant être confrontés à deux questions pour pouvoir faire avancer nos héros, à vous de choisir laquelle vous convient le mieux. La suite de cette histoire dépend entièrement de vous...', false, '181.mp3');
INSERT INTO dialogues VALUES (19, 1, 10, 'limquestion', false, '191.mp3');
INSERT INTO dialogues VALUES (20, 1, 10, 'Pierre commence alors à manipuler la radio pendant un long moment. Jusqu''à ce que quelqu''un l''interrompe soudainement.', false, '201.mp3');
INSERT INTO dialogues VALUES (21, 1, 5, 'Attends !', false, '211.mp3');
INSERT INTO dialogues VALUES (22, 1, 3, 'Je crois que j’ai entendu quelque chose moi aussi, reviens en arrière.', false, '221.mp3');
INSERT INTO dialogues VALUES (23, 1, 3, 'La radio grésille jusqu''à ce que retentissent des mots que nous n’oublierions jamais.', false, '231.mp3');
INSERT INTO dialogues VALUES (24, 1, 9, 'Malgré nos efforts, nous avons été submergés par la force terrestre et aérienne de l''ennemi...', false, '241.mp3');
INSERT INTO dialogues VALUES (25, 1, 3, 'Puis... plus rien.', false, '251.mp3');
INSERT INTO dialogues VALUES (26, 1, 3, 'Ce n''est que le lendemain matin en lisant le journal que nous apprendrons que la guerre était déclarée et qu''une mobilisation nationale allait avoir lieu.', false, '261.mp3');
INSERT INTO dialogues VALUES (27, 1, 1, 'Tu ferais mieux d’éteindre avant d’attirer des problèmes…', true, '271.mp3');
INSERT INTO dialogues VALUES (28, 1, 3, 'Ah, laisse-le faire. Une petite musique ne va pas nous tuer.', true, '281.mp3');
INSERT INTO dialogues VALUES (29, 1, 10, 'La radio grésille un moment, ne produisant que des interférences. Mais peu à peu, une voix s’élève, faible et semblant paniquer.', true, '291.mp3');
INSERT INTO dialogues VALUES (30, 1, 9, 'Si quelqu''un... Ils arrivent... ne vous... cachez vous....', true, '301.mp3');
INSERT INTO dialogues VALUES (31, 1, 10, 'Le silence dans la pièce devient pesant.', true, '311.mp3');
INSERT INTO dialogues VALUES (32, 1, 1, 'C''était quoi ça ?', true, '321.mp3');
INSERT INTO dialogues VALUES (33, 1, 5, 'Chut ! Écoutez...', true, '331.mp3');
INSERT INTO dialogues VALUES (34, 1, 10, 'Pierre ajuste le bouton, cherchant à améliorer le signal, mais il disparaît presque immédiatement dans un grésillement qui semble interminable.', true, '341.mp3');
INSERT INTO dialogues VALUES (35, 1, 1, 'Génial... C''est ça ta fameuse musique ?', true, '351.mp3');
INSERT INTO dialogues VALUES (36, 1, 3, 'Ça ressemblait à un appel à l’aide… Non ? ', true, '361.mp3');
INSERT INTO dialogues VALUES (37, 1, 5, 'Peut-être une vieille transmission, ça arrive quand la fréquence est inutilisée.', true, '371.mp3');
INSERT INTO dialogues VALUES (38, 1, 1, 'Je ne sais pas. Mais je pense qu’il serait plus prudent d’éteindre.', true, '381.mp3');
INSERT INTO dialogues VALUES (39, 1, 10, 'Pierre hésite, mais Raymond lui arrache presque la radio des mains pour la mettre hors tension.', true, '391.mp3');
INSERT INTO dialogues VALUES (40, 1, 3, 'C''est à ce moment qu''on entend toquer à la porte de notre dortoir, je reconnais facilement la voix de ma propriétaire.', true, '401.mp3');
INSERT INTO dialogues VALUES (41, 1, 3, 'Ce qu''elle nous expliqua ensuite nous n''aurions même pas pu l''imaginer... La pologne envahie et l''armée allemande en direction de nos frontières.', true, '411.mp3');
INSERT INTO dialogues VALUES (42, 1, 3, 'Le lendemain nous étions tous mobilisés pour la bataille. Mais la bande de rebelles que nous étions n''allions pas accepter cela, on décida donc de fuir et de se cacher.', true, '421.mp3');
INSERT INTO dialogues VALUES (43, 1, 3, 'La guerre fût déclarée le 3 septembre deux jours après.', true, '431.mp3');
INSERT INTO dialogues VALUES (44, 1, 3, 'Durant un an et demi les combats sévirent, jusqu''à l''armistice du 22 juin 1940.', true, '441.mp3');
INSERT INTO dialogues VALUES (45, 1, 5, 'La suite de notre histoire, elle commença un matin de juillet 1940 dans le sud ouest français.', true, '451.mp3');
INSERT INTO dialogues VALUES (1, 2, 10, '2 ans après la diffusion radio qui aura changé la vie de ces jeunes hommes....', false, '12.mp3');
INSERT INTO dialogues VALUES (2, 2, 3, 'Raymond dégage les fougères derrière lesquelles nous nous sommes cachés pour s''assurer que nous ne soyons pas repérés.', false, '22.mp3');
INSERT INTO dialogues VALUES (3, 2, 1, 'Ils arrivent bientôt ? ', false, '32.mp3');
INSERT INTO dialogues VALUES (4, 2, 3, 'Sûrement, on est au point de rendez vous prévu de toute façon.', false, '42.mp3');
INSERT INTO dialogues VALUES (6, 2, 3, 'Depuis maintenant 2 ans et demi nous avons perdu et la France est désormais coupée en deux. Au début, on se disait que cette situation serait temporaire, et puis ça a tenu et on a commencé a vivre avec.', false, '62.mp3');
INSERT INTO dialogues VALUES (9, 2, 3, 'Soudain des bruits de pas nous sortent de notre torpeur...', false, '92.mp3');
INSERT INTO dialogues VALUES (10, 2, 3, 'Ce doit être eux.', false, '102.mp3');
INSERT INTO dialogues VALUES (11, 2, 3, 'Deux silhouettes se dessinent dans l’ombre et s’approchent de la lumière de notre lampe. Les deux visages que je vois apparaître m''étaient familières', false, '112.mp3');
INSERT INTO dialogues VALUES (12, 2, 3, 'Monsieur et Madame Vasseur ?', false, '122.mp3');
INSERT INTO dialogues VALUES (13, 2, 7, 'Jean ? Raymond ?', false, '132.mp3');
INSERT INTO dialogues VALUES (14, 2, 6, 'C’est vous mes garçons ? Ça pour une surprise !', false, '142.mp3');
INSERT INTO dialogues VALUES (15, 2, 10, 'Les parents de notre ami Pierre étaient apparus à notre lumière. Nous pouvions facilement deviner leur première question.', false, '152.mp3');
INSERT INTO dialogues VALUES (16, 2, 6, 'Où est donc Pierre ?', false, '162.mp3');
INSERT INTO dialogues VALUES (17, 2, 10, 'Demanda Michel en balayant les alentours d''un regard attentif.', false, '172.mp3');
INSERT INTO dialogues VALUES (18, 2, 3, 'On a été séparés, mais il va bien ne vous inquiétez pas, vous le connaissez il se débrouille, il a eu sa propre mission avec André.', false, '182.mp3');
INSERT INTO dialogues VALUES (19, 2, 3, '', false, '192.mp3');
INSERT INTO dialogues VALUES (20, 2, 10, 'Rétorqua rapidement Jean pour rassurer les parents de notre ami.', false, '202.mp3');
INSERT INTO dialogues VALUES (21, 2, 1, 'Je suis désolé de vous interrompre, on doit partir rapidement pour éviter les patrouilles de la milice.', false, '212.mp3');
INSERT INTO dialogues VALUES (22, 2, 6, 'Allons-y !', false, '222.mp3');
INSERT INTO dialogues VALUES (23, 2, 3, 'En traversant la forêt j’explique aux parents de Pierre comment on a été amené à les retrouver, jusqu’à ce qu’un bruit me fasse m’interrompre.', false, '232.mp3');
INSERT INTO dialogues VALUES (24, 2, 3, '', false, '242.mp3');
INSERT INTO dialogues VALUES (25, 2, 3, 'Nous nous jetons tous les quatre dans un recoin caché derrière le buisson que je viens de pointer. Peu de temps après, des bruits de pas passent devant nous.', false, '252.mp3');
INSERT INTO dialogues VALUES (26, 2, 1, 'Des miliciens... Qu’est-ce qu’ils faisaient là ?', false, '262.mp3');
INSERT INTO dialogues VALUES (27, 2, 6, 'Ils étaient sans doute à notre recherche.', false, '272.mp3');
INSERT INTO dialogues VALUES (28, 2, 1, 'Non ça n’a aucun sens, pourquoi ils suivraient de simples réfugiés ?', false, '282.mp3');
INSERT INTO dialogues VALUES (29, 2, 6, 'Vous supérieurs ne vous ont pas expliqué ?', false, '292.mp3');
INSERT INTO dialogues VALUES (30, 2, 3, 'Confus par cette remarque je réponds sans trop réfléchir.', false, '302.mp3');
INSERT INTO dialogues VALUES (31, 2, 3, 'Expliqué quoi ?', false, '312.mp3');
INSERT INTO dialogues VALUES (32, 2, 7, 'Nous ne sommes pas de simples réfugiés, nous transportons des documents de la plus haute importance pour la Résistance, c’est pour ça que l’on doit arriver au plus vite et vivants !', false, '322.mp3');
INSERT INTO dialogues VALUES (33, 2, 3, 'Je regarde Raymond qui semble aussi incrédule que moi.', false, '332.mp3');
INSERT INTO dialogues VALUES (34, 2, 3, 'Après un temps à la réflexion je décide de rétablir l''ambiance qui devenait pesante.', false, '342.mp3');
INSERT INTO dialogues VALUES (35, 2, 3, 'Et bien, on dirait que cette mission est un peu plus importante que ce que l’on pensait !', false, '352.mp3');
INSERT INTO dialogues VALUES (36, 2, 1, 'Où doit on les emmener déjà ?', false, '362.mp3');
INSERT INTO dialogues VALUES (37, 2, 3, 'À Meilhan, de l’autre côté de la colline.', false, '372.mp3');
INSERT INTO dialogues VALUES (38, 2, 1, 'Alors dépêchons-nous, plus vite ils y seront mieux ce sera visiblement. Après toi Jean.', false, '382.mp3');
INSERT INTO dialogues VALUES (39, 2, 3, 'Je tends l’oreille, et, n’entendant aucun bruit qui aurait pu laisser présager une présence humaine, je sors de notre cachette et fais signe à mes compagnons de me suivre', false, '392.mp3');
INSERT INTO dialogues VALUES (40, 2, 3, 'Allons-y.', false, '402.mp3');
INSERT INTO dialogues VALUES (41, 2, 10, 'Environ une heure plus tard.', false, '412.mp3');
INSERT INTO dialogues VALUES (42, 2, 1, 'Enfin !', false, '422.mp3');
INSERT INTO dialogues VALUES (43, 2, 3, 'Après presque une heure de marche nous arrivons enfin en vue des lumières de la ville.', false, '432.mp3');
INSERT INTO dialogues VALUES (44, 2, 7, 'Nous y sommes ?', false, '442.mp3');
INSERT INTO dialogues VALUES (45, 2, 1, 'Oui, on va pouvoir bientôt vous laisser.', false, '452.mp3');
INSERT INTO dialogues VALUES (46, 2, 3, 'Alors que l’on s’avance vers l’orée de la forêt, je remarque une agitation inhabituellement tardive dans les rues : des fenêtres allumées, des bruits dans la pénombre.', false, '462.mp3');
INSERT INTO dialogues VALUES (47, 2, 3, 'Faites attention, il se passe quelque chose de bizarre, longez les murs et restez dans l’ombre, il ne faut pas se faire repérer.', false, '472.mp3');
INSERT INTO dialogues VALUES (48, 2, 6, 'Qu''est-ce qu’il se passe ?', false, '482.mp3');
INSERT INTO dialogues VALUES (49, 2, 3, 'Je lui fais signe de faire le moins de bruit possible.', false, '492.mp3');
INSERT INTO dialogues VALUES (50, 2, 3, 'Les rues et ruelles du petit village défilent alors que nous nous approchons de notre destination.', false, '502.mp3');
INSERT INTO dialogues VALUES (51, 2, 3, 'Mais arrivés au dernier bloc ceux que je vois me permettent d''enfin comprendre l’agitation : un groupe de miliciens arpente les rues, visiblement à la recherche de quelque chose.', false, '512.mp3');
INSERT INTO dialogues VALUES (52, 2, 3, 'Je fais signe aux autres de s’arrêter et leur explique la situation.', false, '522.mp3');
INSERT INTO dialogues VALUES (53, 2, 3, 'Probablement ceux qu’on a vu tout à l’heure', false, '532.mp3');
INSERT INTO dialogues VALUES (54, 2, 10, 'Vous allez maintenant être confrontés à deux questions pour pouvoir aider nos héros, à vous de choisir laquelle vous convient le mieux. La suite de cette histoire dépend entièrement de vous...', false, '542.mp3');
INSERT INTO dialogues VALUES (55, 2, 10, 'limquestion', false, '552.mp3');
INSERT INTO dialogues VALUES (56, 2, 1, 'Allons y alors, ne trainons pas.', false, '562.mp3');
INSERT INTO dialogues VALUES (57, 2, 3, 'Nous revenons sur nos pas, tournons quelques rues plus loin et arrivons à quelques mètres de la cabine.', false, '572.mp3');
INSERT INTO dialogues VALUES (58, 2, 3, 'Je vais les appeler, ne faites rien qui pourrait attirer l’attention et restez silencieux.', false, '582.mp3');
INSERT INTO dialogues VALUES (59, 2, 3, 'Je rentre dans l’espace exigu, compose le numéro et attend. Le téléphone sonne quelques secondes puis quelqu’un décroche', false, '592.mp3');
INSERT INTO dialogues VALUES (60, 2, 9, 'Vous ne deviez pas utiliser ce numéro.', false, '602.mp3');
INSERT INTO dialogues VALUES (61, 2, 3, 'Je sais, mais le point de chute est compromis, la milice est là.', false, '612.mp3');
INSERT INTO dialogues VALUES (62, 2, 9, 'Alors amenez-les nous.', false, '622.mp3');
INSERT INTO dialogues VALUES (63, 2, 3, 'Très bien.', false, '632.mp3');
INSERT INTO dialogues VALUES (65, 2, 3, 'On doit les amener au maquis.', false, '652.mp3');
INSERT INTO dialogues VALUES (66, 2, 1, 'On a un peu de route, on devrait y aller sans plus tarder', false, '662.mp3');
INSERT INTO dialogues VALUES (67, 2, 3, 'Quelques temps plus tard dans la forêt, je sens Raymond nerveux.', false, '672.mp3');
INSERT INTO dialogues VALUES (68, 2, 3, 'Quelque chose ne va pas Raymond ?', false, '682.mp3');
INSERT INTO dialogues VALUES (69, 2, 1, 'Non, je n’aime juste pas quand les plans changent à la dernière minute.', false, '692.mp3');
INSERT INTO dialogues VALUES (70, 2, 3, 'Je comprends, mais ne t’inquiète pas, tout va bien se passer.', false, '702.mp3');
INSERT INTO dialogues VALUES (71, 2, 6, 'Euh… Jean ? On a un problème...', false, '712.mp3');
INSERT INTO dialogues VALUES (1, 1, 10, 'Les forces françaises se retirent peu à peu du front alors que le premier ministre a démissionné il y a seulement quelques jours….', false, '11.mp3');
INSERT INTO dialogues VALUES (3, 1, 3, '𝑁𝑜𝑢𝑠 𝑒́𝑡𝑖𝑜𝑛𝑠 𝑡𝑜𝑢𝑠 𝑙𝑒𝑠 𝟻 𝑑𝑎𝑛𝑠 𝑠𝑎 𝑐ℎ𝑎𝑚𝑏𝑟𝑒 𝑐𝑎𝑟 𝑖𝑙 𝑒́𝑡𝑎𝑖𝑡 𝑙𝑒 𝑠𝑒𝑢𝑙 𝑎̀ 𝑛𝑒 𝑝𝑎𝑠 𝑜𝑠𝑒𝑟 𝑠𝑜𝑟𝑡𝑖𝑟 𝑑𝑎𝑛𝑠 𝑙𝑒𝑠 𝑐𝑜𝑢𝑙𝑜𝑖𝑟𝑠 𝑎𝑝𝑟𝑒̀𝑠 𝑙𝑒 𝑐𝑜𝑢𝑣𝑟𝑒 𝑓𝑒𝑢, 𝑐𝑒 𝑞𝑢𝑖 𝑛’𝑒́𝑡𝑎𝑖𝑡 𝑝𝑎𝑠 𝑑𝑢 𝑡𝑜𝑢𝑡 𝑙𝑒 𝑐𝑎𝑠 𝑑𝑒 𝑃𝑖𝑒𝑟𝑟𝑒 𝑑’𝑎𝑖𝑙𝑙𝑒𝑢𝑟𝑠..', false, '31.mp3');
INSERT INTO dialogues VALUES (5, 2, 3, 'Cela va bientôt faire 1 heure que l’on attend nos contacts au point de rendez-vous pour qu’il nous délivre un certain colis. L’ordre de mission était arrivé au maquis ce matin : escorter deux refugiés en lieu sûr. L’ordre avait été émis par Mr Jean Moulin en personne. 10 h plus tard, nous nous retrouvions donc en forêt, cachés derrière des fougères à attendre.', false, '52.mp3');
...
INSERT INTO dialogues VALUES (8, 2, 3, 'Nous avons d’abord été surtout assigné à des missions de moindre importance, et un jour mes connaissances de la région m''ont amené à devenir l''acteur principal des escortes qui devaient être réalisées.. Je suis donc devenu le guide qui doit ouvrir des voies pour les refugiés qui fuient le nord et l’occupation. Et aujourd’hui n’était pas une exception.', false, '82.mp3');
INSERT INTO dialogues VALUES (64, 2, 3, 'Je raccroche et ressors. Marie et Michel m’attendaient, de même pour Raymond qui s’était visiblement écarté quelques temps. Je le préviens des nouveautés de la situation.', false, '642.mp3');
INSERT INTO dialogues VALUES (72, 2, 3, 'Sur le chemin un homme nous barre la route, armé. Pendant ma discussion avec Raymond j’ai laissé
les vasseurs prendre de l’avance et j’ai relâché ma garde.', false, '722.mp3');
INSERT INTO dialogues VALUES (73, 2, 3, 'Peu à peu des soldats sortent des buissons et nous encerclent…', false, '732.mp3');
INSERT INTO dialogues VALUES (74, 2, 3, 'Des amis à moi ont vécus dans le village, leur maison devrait toujours être inoccupée, allons-y.', true, '742.mp3');
INSERT INTO dialogues VALUES (75, 2, 3, 'Je les dirige vers les abords de la ville. Sur la route R aymond s’approche de moi, nerveux.', true, '752.mp3');
INSERT INTO dialogues VALUES (76, 2, 1, 'Donc on les garde ?', true, '762.mp3');
INSERT INTO dialogues VALUES (77, 2, 3, 'Pour l’instant du moins. On les amènera demain au point de chute initial.', true, '772.mp3');
INSERT INTO dialogues VALUES (78, 2, 3, 'La maison, bien qu’inhabitée depuis plusieurs années, est restée dans un bon état. Je pousse la porte et
allume la lumière.', true, '782.mp3');
INSERT INTO dialogues VALUES (79, 2, 3, 'Il n’y a sûrement plus rien a mangé mais les matelas devraient être là, vous devriez pouvoir vous
installer dans une chambre pour dormir.', true, '792.mp3');
INSERT INTO dialogues VALUES (80, 2, 3, 'Les vasseurs montent à l’étage pendant que Raymond et moi nous installons dans le salon, sur ce qui semble être des 
canapés, difficile à dire au vu de la dégradation.', true, '802.mp3');
INSERT INTO dialogues VALUES (81, 2, 3, 'Soudain, j’entends frapper à la porte. Je regarde avec angoisse à travers les rideaux, et reste figé de
peur tandis que les formes des miliciens se dessinent dans le noir.', true, '812.mp3');
INSERT INTO dialogues VALUES (82, 2, 3, 'Je fais signe à Raymond de s’occuper de nos amis et de s’enfuir, puis m’approche de la porte et l’ouvre.', true, '822.mp3');
INSERT INTO dialogues VALUES (83, 2, 3, 'Bonsoir messieurs, en quoi puis-je vous aider ?', true, '832.mp3');
INSERT INTO dialogues VALUES (84, 2, 8, 'Bien le bonsoir mon brave, excusez-nous de vous déranger si tardivement mais nous sommes à la recherche d’un couple de fugitifs. Est-ce que vous les auriez vus ?', true, '842.mp3');
INSERT INTO dialogues VALUES (85, 2, 3, 'Des fugitifs, vous dites ? Non, je n’ai vu personne, désolé.', true, '852.mp3');
INSERT INTO dialogues VALUES (86, 2, 8, 'Voilà qui est bien dommage. Mais dites-moi, nous pensions la maison abandonnée, et nous avons été étonnés de voir de la lumière. Vous êtes arrivé récemment ?', true, '862.mp3');
INSERT INTO dialogues VALUES (87, 2, 3, 'Oh, oui effectivement, il y a quelques jours seulement. Je ne suis que de passage, je voyage vers les Pyrénées pour y retrouver de la famille. Cela faisait plusieurs jours que je marchais, aussi ai-je décidé de m’arrêter quelques temps ici.', true, '872.mp3');
INSERT INTO dialogues VALUES (88, 2, 8, 'Je vois ! Mais voyez-vous, il y a quelque chose qui me dérange : des fugitifs, une maison abandonnée qui ne l’est plus, et un voyageur que personne n’a vu... et tout ça en une journée, cela fait beaucoup de coïncidences. Et je ne crois pas aux coïncidences...', true, '882.mp3');
INSERT INTO dialogues VALUES (89, 2, 8, 'Fouillez la maison ! Et vous !', true, '892.mp3');
INSERT INTO dialogues VALUES (90, 2, 8, '.    .    .', true, '902.mp3');
INSERT INTO dialogues VALUES (91, 2, 8, 'Vous allez venir avec nous.', true, '912.mp3');
INSERT INTO dialogues VALUES (92, 2, 3, 'Il semblerait que je n’ai plus qu’à espérer que Raymond ait réussi à s’enfuir avec les Vasseurs.', true, '922.mp3');
